...
import { AccessDeniedException as __AccessDeniedException, ConflictException as __ConflictException, HumanLoopQuotaExceededException as __HumanLoopQuotaExceededException, IdempotentParameterMismatchException as __IdempotentParameterMismatchException, ImageTooLargeException as __ImageTooLargeException, InternalServerError as __InternalServerError, InvalidImageFormatException as __InvalidImageFormatException, InvalidManifestException as __InvalidManifestException, InvalidPaginationTokenException as __InvalidPaginationTokenException, InvalidParameterException as __InvalidParameterException, InvalidPolicyRevisionIdException as __InvalidPolicyRevisionIdException, InvalidS3ObjectException as __InvalidS3ObjectException, LimitExceededException as __LimitExceededException, MalformedPolicyDocumentException as __MalformedPolicyDocumentException, ProvisionedThroughputExceededException as __ProvisionedThroughputExceededException, ResourceAlreadyExistsException as __ResourceAlreadyExistsException, ResourceInUseException as __ResourceInUseException, ResourceNotFoundException as __ResourceNotFoundException, ResourceNotReadyException as __ResourceNotReadyException, ServiceQuotaExceededException as __ServiceQuotaExceededException, SessionNotFoundException as __SessionNotFoundException, ThrottlingException as __ThrottlingException, VideoTooLargeException as __VideoTooLargeException, } from "../models/errors";
import { RekognitionServiceException as __RekognitionServiceException } from "../models/RekognitionServiceException";
export var LivenessImageBlob = [0, n0, _LIB, 8, 21];
...
export var DatasetLabelDescription = [3, n0, _DLD, 0, [_LN, _LS], [0, () => DatasetLabelStats]];
...
export var ListFacesRequest = [3, n0, _LFR, 0, [_CI, _NT, _MR, _UI, _FIa], [0, 0, 1, 0, 64 | 0]];
...
export var Assets = [1, n0, _As, 0, () => Asset];
export var AssociatedFacesList = [1, n0, _AFL, 0, () => AssociatedFace];
export var Attributes = 64 | 0;
export var AudioMetadataList = [1, n0, _AML, 0, () => AudioMetadata];
export var AuditImages = [1, n0, _AIu, 0, [() => AuditImage, 0]];
export var BodyParts = [1, n0, _BP, 0, () => ProtectiveEquipmentBodyPart];
export var CelebrityList = [1, n0, _CLe, 0, () => Celebrity];
export var CelebrityRecognitions = [1, n0, _CRe, 0, () => CelebrityRecognition];
export var ChallengePreferences = [1, n0, _CPh, 0, () => ChallengePreference];
export var CollectionIdList = 64 | 0;
export var ComparedFaceList = [1, n0, _CFL, 0, () => ComparedFace];
export var CompareFacesMatchList = [1, n0, _CFML, 0, () => CompareFacesMatch];
export var CompareFacesUnmatchList = [1, n0, _CFUL, 0, () => ComparedFace];
export var ConnectedHomeLabels = 64 | 0;
export var ContentClassifiers = 64 | 0;
export var ContentModerationDetections = [1, n0, _CMDo, 0, () => ContentModerationDetection];
export var ContentTypes = [1, n0, _CT, 0, () => ContentType];
export var CustomizationFeatures = 64 | 0;
export var CustomLabels = [1, n0, _CLu, 0, () => CustomLabel];
export var DatasetEntries = 64 | 0;
export var DatasetLabelDescriptions = [1, n0, _DLDa, 0, () => DatasetLabelDescription];
export var DatasetLabels = 64 | 0;
export var DatasetMetadataList = [1, n0, _DMLa, 0, () => DatasetMetadata];
export var DetectLabelsFeatureList = 64 | 0;
export var DisassociatedFacesList = [1, n0, _DFL, 0, () => DisassociatedFace];
export var DistributeDatasetMetadataList = [1, n0, _DDML, 0, () => DistributeDataset];
export var DominantColors = [1, n0, _DCo, 0, () => DominantColor];
export var Emotions = [1, n0, _E, 0, () => Emotion];
export var EquipmentDetections = [1, n0, _EDq, 0, () => EquipmentDetection];
export var FaceDetailList = [1, n0, _FDL, 0, () => FaceDetail];
export var FaceDetections = [1, n0, _FDace, 0, () => FaceDetection];
export var FaceIdList = 64 | 0;
export var FaceList = [1, n0, _FL, 0, () => Face];
export var FaceMatchList = [1, n0, _FML, 0, () => FaceMatch];
export var FaceModelVersionList = 64 | 0;
export var FaceRecordList = [1, n0, _FRL, 0, () => FaceRecord];
export var GeneralLabelsFilterList = 64 | 0;
export var HumanLoopActivationReasons = 64 | 0;
export var Instances = [1, n0, _Inst, 0, () => Instance];
export var LabelAliases = [1, n0, _LAa, 0, () => LabelAlias];
export var LabelCategories = [1, n0, _LCa, 0, () => LabelCategory];
export var LabelDetectionFeatureList = 64 | 0;
export var LabelDetections = [1, n0, _LDa, 0, () => LabelDetection];
export var Labels = [1, n0, _Lab, 0, () => Label];
export var Landmarks = [1, n0, _La, 0, () => Landmark];
export var MediaAnalysisJobDescriptions = [1, n0, _MAJDe, 0, () => MediaAnalysisJobDescription];
export var ModerationLabels = [1, n0, _MLo, 0, () => ModerationLabel];
export var Parents = [1, n0, _Pa, 0, () => Parent];
export var PersonDetections = [1, n0, _PDers, 0, () => PersonDetection];
export var PersonMatches = [1, n0, _PMe, 0, () => PersonMatch];
export var Polygon = [1, n0, _Po, 0, () => Point];
export var ProjectDescriptions = [1, n0, _PD, 0, () => ProjectDescription];
export var ProjectNames = 64 | 0;
export var ProjectPolicies = [1, n0, _PPr, 0, () => ProjectPolicy];
export var ProjectVersionDescriptions = [1, n0, _PVD, 0, () => ProjectVersionDescription];
export var ProtectiveEquipmentPersonIds = 64 | 1;
export var ProtectiveEquipmentPersons = [1, n0, _PEPr, 0, () => ProtectiveEquipmentPerson];
export var ProtectiveEquipmentTypes = 64 | 0;
export var Reasons = 64 | 0;
export var RegionsOfInterest = [1, n0, _ROI, 0, () => RegionOfInterest];
export var SegmentDetections = [1, n0, _SDeg, 0, () => SegmentDetection];
export var SegmentTypes = 64 | 0;
export var SegmentTypesInfo = [1, n0, _STIe, 0, () => SegmentTypeInfo];
export var StreamProcessorList = [1, n0, _SPL, 0, () => StreamProcessor];
export var StreamProcessorParametersToDelete = 64 | 0;
export var TagKeyList = 64 | 0;
export var TextDetectionList = [1, n0, _TDL, 0, () => TextDetection];
export var TextDetectionResults = [1, n0, _TDRext, 0, () => TextDetectionResult];
export var UnindexedFaces = [1, n0, _UFn, 0, () => UnindexedFace];
export var UnsearchedFaceReasons = 64 | 0;
export var UnsearchedFacesList = [1, n0, _UFL, 0, () => UnsearchedFace];
export var UnsuccessfulFaceAssociationList = [1, n0, _UFAL, 0, () => UnsuccessfulFaceAssociation];
export var UnsuccessfulFaceAssociationReasons = 64 | 0;
export var UnsuccessfulFaceDeletionReasons = 64 | 0;
export var UnsuccessfulFaceDeletionsList = [1, n0, _UFDL, 0, () => UnsuccessfulFaceDeletion];
export var UnsuccessfulFaceDisassociationList = [
    1,
    n0,
    _UFDLn,
    0,
...
export var DeleteFaces = [9, n0, _DFel, 0, () => DeleteFacesRequest, () => DeleteFacesResponse];
...
export var DetectFaces = [9, n0, _DFet, 0, () => DetectFacesRequest, () => DetectFacesResponse];
export var DetectLabels = [9, n0, _DL, 0, () => DetectLabelsRequest, () => DetectLabelsResponse];
...
export var SearchFaces = [9, n0, _SFe, 0, () => SearchFacesRequest, () => SearchFacesResponse];
...
export var SearchUsers = [9, n0, _SUe, 0, () => SearchUsersRequest, () => SearchUsersResponse];
